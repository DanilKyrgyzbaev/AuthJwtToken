...
import com.example.authjwttoken.repository.RoleRepository;
import com.example.authjwttoken.repository.UserRepository;
...
public class UserServiceImplements implements UserService, UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user == null){
            ...
            log.info("User fund in the database: {}",username);
        }
